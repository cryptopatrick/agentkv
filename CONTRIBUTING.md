...
First off, thank you for considering contributing to agentkv. 
It's people like you that make agentkv great!
...
```bash
git clone https://github.com/cryptopatrick/agentkv.git
cd agentkv
```
...
To run agentkv, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/agentkv/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/agentkv/issues) to report any bugs or request new features.
...
Thank you for contributing to agentkv!
